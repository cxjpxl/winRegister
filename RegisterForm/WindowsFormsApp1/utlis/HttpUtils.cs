    ...
    public class HttpUtils
    {
        ...
        public static int getImage(String url, String name, CookieContainer cookie, JObject headJObject)
        {
            ...
            try
            {
                ...
                if (Directory.Exists(System.AppDomain.CurrentDomain.BaseDirectory + "/pic/"))
                {

                }
                else {
                    Directory.CreateDirectory(System.AppDomain.CurrentDomain.BaseDirectory + "/pic/"); //新建文件夹   
                }
                FileStream writer = new FileStream(System.AppDomain.CurrentDomain.BaseDirectory+"/pic/" + name, FileMode.OpenOrCreate, FileAccess.Write);
